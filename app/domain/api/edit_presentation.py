...
#layout_main_panel_right > .w2ui-layout {
    position: absolute;
    top: 0;
    left: 0;
    right: 0;
...
const presTitle = '{presentation.title}';
const presFooter = '{presentation.footer}';
let slides = [
    {',\n    '.join(slides)},
];
let sbNodes = [];
